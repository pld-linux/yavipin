...
Yavipind jest pakietem tworzącym bezpieczne tunele pomiędzy dwoma
komputerami. Przesyła każdy rodzaj pakietów (IPv4, IPv6, inne) poprzez
wirtualne urządzenie point-to-point (np. tun0). Pracuje całkowicie w
